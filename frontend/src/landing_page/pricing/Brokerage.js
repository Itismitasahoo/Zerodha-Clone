    ...
    <div className="container border-top">
      <div className="row p-5 mt-3">
        ...
        <div className="col-6 p-4">
          <h1 className="text-muted fs-3">Charges explained</h1>

          <h3 className="text-muted fs-6 mt-5">
          ...
          <h3 className="text-muted fs-6 mt-4">Transaction/Turnover Charges</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Call & trade</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Stamp charges</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">NRI brokerage charges</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Account with debit balance</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">
        ...
        {/* RIGHT SIDE */}
        <div className="col-6 p-4">
          <h3 className="text-muted fs-6">GST</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">SEBI Charges</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Pledging charges</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Off-market transfer charges</h3>

          <p className="text-muted fs-6">₹25 per transaction.</p>

          <h3 className="text-muted fs-6 mt-4">Physical CMR request</h3>
          ...
          <h3 className="text-muted fs-6 mt-4">Payment gateway charges</h3>

          <p className="text-muted fs-6">
            ₹9 + GST (Not levied on transfers done via UPI)
          </p>

          <h3 className="text-muted fs-6 mt-4">Delayed Payment Charges</h3>
      ...
      <div className="row p-5">
        <div className="col-12">
          <h3 className="text-muted fs-6">Disclaimer</h3>
